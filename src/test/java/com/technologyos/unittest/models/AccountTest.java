...
class AccountTest {
   ...
   void setup(TestInfo testInfo, TestReporter testReporter){
      victoria = new User("Vic01", "Victoria", 22,"Justice","Dawn");
      victoriaAccount = new Account(victoria, new BigDecimal("1000"));

      selena = new User("Sel01", "Selena", 22,"Gomez","Marie");
   ...
   void account_name_is_equal_to_taylor(){
      User user = new User("Tay01", "Taylor", 22,"Swift","Alison");
   ...
   void user_balance_is_equal_to_a_specific_amount_and_greater_than_zero(){
      User user = new User("Sab01", "Sabrina Ann", 22,"Carpenter","Lynn");
   ...
   void old_account_equal_to_the_new_account(){
      User user = new User("Sel01", "Selena", 22,"Gomez","Marie");
